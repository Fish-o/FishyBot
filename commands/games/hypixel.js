...
exports.run = async(client, message, args) => {
    ...
    try{
        ...
        console.log(err)
        client.sendinfo('Error has occured with the hypixel command')
        message.channel.send('An error has occured, please try again. If it still wont work, contact '+client.config.author)
    }
}
