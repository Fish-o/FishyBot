/*btw vmrl has an api:
https://vrmasterleague.com/Services.asmx/GetTeamPlayersStats?game=onward&activeOnly=false&includeRetired=false
...
exports.run = async(client, message, args) => {
    ...
    */
    ...
    const logo_url = `https://vrmasterleague.com/Services.asmx/GetTeamLogo?game=onward&teamName=${team_name_url}`
    const stats_url = `https://vrmasterleague.com/Services.asmx/GetTeamStats?game=onward&teamName=${team_name_url}`;
